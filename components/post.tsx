      ...
      <div>
        <div className="flex w-full justify-between  text-neutral-500">
          <div className="flex items-center gap-x-2">
            <p className=" text-neutral-200 font-semibold">Ethel Richards</p>
        ...
        <div>
          ...
          <div className="relative h-[400px] rounded-xl overflow-hidden border border-neutral-700 mt-3">
            <Image
          ...
          <div className="flex items-center justify-between gap-x-10 mt-1">
            <div className="flex w-full items-center justify-between">
              <button className="flex items-center text-neutral-500 group">
                <MessageCircle className="size-9 group-hover:bg-sky-500/20 p-2 rounded-full group-hover:text-sky-500 transition-colors duration-200 ease-in-out" />
                <span className="text-sm group-hover:text-sky-500 transition-colors duration-200 ease-in-out">
                  78
                </span>
              </button>

              <button className="flex items-center text-neutral-500 group">
                <Repeat2 className="size-9 group-hover:bg-green-500/20 p-2 rounded-full group-hover:text-green-500 transition-colors duration-200 ease-in-out" />
                <span className="text-sm group-hover:text-green-500 transition-colors duration-200 ease-in-out">
                  1K
                </span>
              </button>

              <button className="flex items-center text-neutral-500 group">
                <Heart className="size-9 group-hover:bg-rose-500/20 p-2 rounded-full group-hover:text-rose-500 transition-colors duration-200 ease-in-out" />
                <span className="text-sm group-hover:text-rose-500 transition-colors duration-200 ease-in-out">
                  18K
                </span>
              </button>

              <button className="flex items-center text-neutral-500 group">
                <BarChart2 className="size-9 group-hover:bg-sky-500/20 p-2 rounded-full group-hover:text-sky-500 transition-colors duration-200 ease-in-out" />
                <span className="text-sm group-hover:text-sky-500 transition-colors duration-200 ease-in-out">
                  1.6M
                </span>
              </button>
